...
sudo -u splunk mkdir /opt/splunk/tutorialdata
sudo -u splunk wget -O /opt/splunk/tutorialdata/tutorialdata.zip 'http://docs.splunk.com/images/Tutorial/tutorialdata.zip'
sudo -u splunk unzip /opt/splunk/tutorialdata/tutorialdata.zip -d /opt/splunk/tutorialdata

sudo -u splunk rm /opt/splunk/tutorialdata/tutorialdata.zip
